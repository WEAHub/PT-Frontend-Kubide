...
- La aplicación consume la <a href="https://developer.marvel.com/">API de Marvel</a> y almacena los datos obtenidos en un store <a href="http://ngrx.io" target="_blank">NGRX</a> con <a href="https://v14.ngrx.io/guide/entity/adapter">adaptadores de entidad</a>.
